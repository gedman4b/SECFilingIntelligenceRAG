...
CANONICAL_METRICS: List[CanonicalMetric] = [
    CanonicalMetric(
        ...
        known_labels=["Total revenues", "Total net sales", "Net revenues"],
    ),
    CanonicalMetric(
        metric_id="METRIC_COST_OF_REVENUE",
        display_name="Total cost of revenue",
        statement="income_stmt",
        known_labels=["Total cost of revenues", "Total cost of sales"],
    ),
    CanonicalMetric(
    ...
    CanonicalMetric(
        ...
        statement="income_stmt",
        known_labels=["Total operating expenses"],
    ),
    CanonicalMetric(
        metric_id="METRIC_OPERATING_INCOME",
        display_name="Operating income",
        statement="income_stmt",
        known_labels=["Income from operations", "Operating income"],
    ),
    CanonicalMetric(
        metric_id="METRIC_NET_INCOME",
        display_name="Net income",
        statement="income_stmt",
        known_labels=["Net income", "Net income (loss)", "Net earnings"],
    ),
    CanonicalMetric(
        ...
        known_labels=["Net income attributable to common stockholders"],
    ),
    CanonicalMetric(
        metric_id="METRIC_TOTAL_ASSETS",
        display_name="Total assets",
        statement="balance_sheet",
        known_labels=["Total assets"],
    ),
    CanonicalMetric(
        metric_id="METRIC_TOTAL_LIABILITIES",
        display_name="Total liabilities",
        statement="balance_sheet",
        known_labels=["Total liabilities"],
    ),
    CanonicalMetric(
    ...
    CanonicalMetric(
        ...
        statement="balance_sheet",
        known_labels=["Cash and cash equivalents"],
    ),
    CanonicalMetric(
